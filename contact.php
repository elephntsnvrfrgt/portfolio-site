	        ...
	        <div id="main" class="clearfix" role="main">
	        	...
	        	<div class="column-8 float-left clear-both">
	        		<div class="width-control contents">
	        			<h2 class="title">Please say hello</h2>
	        			<p>Do so by emailing me at, hello@isaacmart[dot]in or using the contact form provided. I look forward to hearing from you.</p>
